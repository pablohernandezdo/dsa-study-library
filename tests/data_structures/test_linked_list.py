...
def test_create_non_empty_linked_list():
...
def test_repr_empty_linked_list():
    linked_list = LinkedList()
    assert linked_list.__repr__() == "LinkedList([])"


def test_repr_one_item_linked_list():
    linked_list = LinkedList([10])
    assert linked_list.__repr__() == "LinkedList([10])"


def test_repr_non_empty_linked_list():
...
def test_str_one_item_linked_list():
    linked_list = LinkedList([10])
    assert str(linked_list) == "10"


def test_str_non_empty_linked_list():
    linked_list = LinkedList([30, 20, 10])
...
def test_insert_front_non_empty_list():
    linked_list = LinkedList()
    linked_list.insert_front(10)
...
def test_insert_back_empty_list():
    linked_list = LinkedList()
    linked_list.insert_back(10)
    assert list(linked_list) == [10]


def test_insert_back_non_empty_list():
    linked_list = LinkedList()
    linked_list.insert_back(10)
...
def test_find_first_value_linked_list():
    linked_list = LinkedList([1, 2, 3])
    assert linked_list.find(1) == 0


def test_find_middle_value_linked_list():
    linked_list = LinkedList([1, 2, 3])
    assert linked_list.find(2) == 1


def test_find_last_value_linked_list():
    linked_list = LinkedList([1, 2, 3])
    assert linked_list.find(3) == 2


def test_find_missing_value_linked_list():
    linked_list = LinkedList([1, 2, 3])
